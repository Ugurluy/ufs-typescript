    ...
    >
      <template v-slot:top>
        <v-toolbar flat color="white">
          <v-toolbar-title>{{
            translate.t("FORMS.DESIPARCA.NAME")
          }}</v-toolbar-title>
                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.RECORD_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.FORM_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.FORM_ADI')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.İŞ_EMRİ')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.CUSTOMER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.cap"
                        required
                        :label="translate.t('FORMS.DESIPARCA.DIAMETER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.SKIN_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.SKIN_QUANTITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.lot"
                        required
                        :label="translate.t('FORMS.DESIPARCA.LOT')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.desi"
                        required
                        :label="translate.t('FORMS.DESIPARCA.DECI')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.ekliKece"
                        required
                        :label="
                          translate.t('FORMS.DESIPARCA.ATTACHED_PAD_QUANTITY')
                        "
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.eldiven"
                        required
                        :label="translate.t('FORMS.DESIPARCA.GLOVES')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.not"
                        required
                        :label="translate.t('FORMS.DESIPARCA.NOTE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.APPROVAL')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.DESIPARCA.OPERATOR_NAME')"
                      ></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
