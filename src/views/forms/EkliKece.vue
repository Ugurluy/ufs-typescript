    ...
    >
      <template v-slot:top>
        <v-toolbar flat color="white">
          <v-toolbar-title>{{
            translate.t("FORMS.EKLIKECE.NAME")
          }}</v-toolbar-title>
                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.RECORD_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.FORM_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.FORM_ADI')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.İŞ_EMRİ')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.CUSTOMER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.cap"
                        required
                        :label="translate.t('FORMS.EKLIKECE.DIAMETER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.iskelet"
                        required
                        :label="translate.t('FORMS.EKLIKECE.FRAME')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.parca"
                        required
                        :label="translate.t('FORMS.EKLIKECE.PART')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.kesim"
                        required
                        :label="translate.t('FORMS.EKLIKECE.CUT')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.birlesim"
                        required
                        :label="translate.t('FORMS.EKLIKECE.UNION')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.HAIR_HEIGHT')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.SKIN_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.SKIN_QUANTITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.not"
                        required
                        :label="translate.t('FORMS.EKLIKECE.NOTE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.APPROVAL')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.EKLIKECE.OPERATOR_NAME')"
                      ></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
...
import EkliKeceForm from "@/models/EkliKeceForm";

@Component
export default class DesiParca extends Vue {
  forms: EkliKeceForm[];
  formModel: EkliKeceForm[];
  formAdi: string;
