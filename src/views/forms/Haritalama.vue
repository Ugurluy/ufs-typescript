    ...
    >
      <template v-slot:top>
        <v-toolbar flat color="white">
          <v-toolbar-title>{{
            translate.t("FORMS.HARITALAMA.NAME")
          }}</v-toolbar-title>
                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.RECORD_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.FORM_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.FORM_ADI')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.İŞ_EMRİ')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.CUSTOMER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.cap"
                        required
                        :label="translate.t('FORMS.HARITALAMA.DIAMETER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.ORDER_QUANTITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.deriKalitesi"
                        required
                        :label="translate.t('FORMS.HARITALAMA.SKIN_QUALITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.HAIR_HEIGHT')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.SKIN_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.SKIN_QUANTITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.VELCRO_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.VELCRO_COLOR')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.not"
                        required
                        :label="translate.t('FORMS.HARITALAMA.NOTE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.APPROVAL')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.HARITALAMA.OPERATOR_NAME')"
                      ></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
...
import HaritalamaForm from "@/models/HaritalamaForm";
import Definition from "@/models/Definition";
import DefinitionsController from "@/controllers/DefinitionsController";
import ColumnNames from "@/models/ColumnNames";

@Component
export default class Haritalama extends Vue {
  forms: HaritalamaForm[];
  formModel: HaritalamaForm[];
  formAdi: string;
