    ...
    >
      <template v-slot:top>
        <v-toolbar flat color="white">
          <v-toolbar-title>{{
            translate.t("FORMS.ISKARTA_TAKIP.NAME")
          }}</v-toolbar-title>
                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.RECORD_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.FORM_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.FORM_ADI')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.İŞ_EMRİ')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.CUSTOMER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.cap"
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.DIAMETER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="
                          translate.t('FORMS.ISKARTA_TAKIP.ORDER_QUANTITY')
                        "
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.HAIR_HEIGHT')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.SKIN_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="
                          translate.t('FORMS.ISKARTA_TAKIP.SKIN_QUANTITY')
                        "
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.VELCRO_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.VELCRO_COLOR')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.iskartaSebep"
                        required
                        :label="
                          translate.t('FORMS.ISKARTA_TAKIP.ISKARTA_SEBEP')
                        "
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.iskartaAdet"
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.ISKARTA_ADET')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.yirtikAdet"
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.YIRTIK_ADET')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.not"
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.NOTE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.ISKARTA_TAKIP.APPROVAL')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="
                          translate.t('FORMS.ISKARTA_TAKIP.OPERATOR_NAME')
                        "
                      ></v-text-field>
                    </v-col>
                  </v-row>
...
import IskartaTakipForm from "@/models/IskartaTakipForm";
import Definition from "@/models/Definition";
import DefinitionsController from "@/controllers/DefinitionsController";
import ColumnNames from "@/models/ColumnNames";

@Component
export default class IskartaTakip extends Vue {
  forms: IskartaTakipForm[];
  formModel: IskartaTakipForm[];
  formAdi: string;
