                  ...
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.RECORD_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.FORM_ID')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.FORM_ADI')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.İŞ_EMRİ')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.CUSTOMER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.cap"
                        required
                        :label="translate.t('FORMS.KESIM.DIAMETER')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.ORDER_QUANTITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.HAIR_HEIGHT')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.SKIN_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.SKIN_QUANTITY')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.VELCRO_TYPE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.VELCRO_COLOR')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.kesimeGirenAdet"
                        required
                        :label="translate.t('FORMS.KESIM.KESIME_GIREN')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.kesilenIskeletAdet"
                        required
                        :label="translate.t('FORMS.KESIM.KESILEN_ISKELET')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.kesilenParcaAdet"
                        required
                        :label="translate.t('FORMS.KESIM.KESILEN_PARCA_ADET')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.kesilenAdet"
                        required
                        :label="translate.t('FORMS.KESIM.KESILEN_ADET')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="newForm.not"
                        required
                        :label="translate.t('FORMS.KESIM.NOTE')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.APPROVAL')"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        ...
                        required
                        :label="translate.t('FORMS.KESIM.OPERATOR_NAME')"
                      ></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
